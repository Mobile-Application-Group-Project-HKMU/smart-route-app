...
import { StyleSheet, ActivityIndicator, FlatList, TouchableOpacity, Alert, View, Dimensions } from 'react-native';
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => (
              ...
              >
                <ThemedView style={[
                  styles.stopSequence,
                  nearestStopIndex === index ? styles.nearestStopSequence : null
                ]}>
                  <ThemedText style={[
                    styles.sequenceNumber,
                    nearestStopIndex === index ? styles.nearestStopSequenceText : null
                  ]}>{item.seq}</ThemedText>
                </ThemedView>
